...
export default function AspectEdit({ aspect }: Props) {
    const defaultValues = {
        code: aspect.code,
        name: aspect.latest_aspect_version.name,
        description: aspect.latest_aspect_version.description,
        questions: aspect.latest_aspect_version.question_versions.map((q) => ({
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title={`Edit Aspek ${aspect.latest_aspect_version.name}`} />
                ...
                <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:max-w-7xl lg:px-8">
                    <Card>
                        ...
                        <CardHeader className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                            <div>
                                <CardTitle className="text-lg font-bold md:text-2xl">Edit Aspek {aspect.latest_aspect_version.name}</CardTitle>
                                <p className="text-sm text-gray-600 dark:text-gray-400">Perbarui aspek penilaian yang sudah ada</p>
                            </div>
                                ...
                                <Card>
                                    ...
                                    <CardContent className="space-y-6">
                                        <div>
                                            ...
                                            <Input id="code" value={aspect.code} disabled />
