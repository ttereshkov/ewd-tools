                        ...
                        <div className="backdrop-blur-sm bg-white/70 dark:bg-gray-900/70 rounded-2xl border border-orange-200/50 dark:border-orange-800/50 shadow-xl shadow-orange-500/10 dark:shadow-orange-500/5">
                            <div className="p-8">
                                <div className="flex flex-col gap-6 sm:flex-row sm:items-center sm:justify-between mb-8">
                                    <div>
                                        <h2 className="text-xl font-semibold text-orange-700 dark:text-orange-300">Informasi User</h2>
                                        <p className="text-sm text-orange-600/70 dark:text-orange-300/70 mt-1">Detail lengkap pengguna sistem</p>
                                    </div>
                                ...
                                <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
                                    <div className="space-y-3 p-6 rounded-xl bg-gradient-to-br from-orange-50 to-amber-50 dark:from-orange-900/30 dark:to-amber-900/30 border border-orange-200/50 dark:border-orange-800/50">
                                        <div className="flex items-center gap-3">
                                            ...
                                            <div className="text-sm font-medium text-orange-700 dark:text-orange-300">Nama Lengkap</div>
                                        </div>
                                        <div className="text-lg font-semibold text-gray-900 dark:text-gray-100 ml-10">{user.name}</div>
                                    </div>
                                    ...
                                    <div className="space-y-3 p-6 rounded-xl bg-gradient-to-br from-orange-50 to-amber-50 dark:from-orange-900/30 dark:to-amber-900/30 border border-orange-200/50 dark:border-orange-800/50">
                                        <div className="flex items-center gap-3">
                                            ...
                                            <div className="text-sm font-medium text-orange-700 dark:text-orange-300">Email</div>
                                        </div>
                                        <div className="text-lg font-semibold text-gray-900 dark:text-gray-100 ml-10">{user.email}</div>
                                    </div>
                                    ...
                                    <div className="space-y-3 p-6 rounded-xl bg-gradient-to-br from-orange-50 to-amber-50 dark:from-orange-900/30 dark:to-amber-900/30 border border-orange-200/50 dark:border-orange-800/50">
                                        <div className="flex items-center gap-3">
                                            ...
                                            <div className="text-sm font-medium text-orange-700 dark:text-orange-300">Divisi</div>
                                        </div>
                                        <div className="text-lg font-semibold text-gray-900 dark:text-gray-100 ml-10">{user.division?.name || 'Tidak ada divisi'}</div>
                                    </div>
                                </div>
